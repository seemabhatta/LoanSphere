...
def generate_data_dictionary_with_connection(snowflake_connection, table_names: List[str], 
                                           database_name: str, schema_name: str, 
                                           connection_id: str = "session") -> Dict[str, Any]:
    """
    Generate comprehensive YAML data dictionary using pre-established connection
    Enhanced version for better performance with connection reuse
    """
    try:
        ...
        for table_name in table_names:
            try:
                ...
                # Get detailed column information using pre-established connection
...
def get_table_columns_with_connection(snowflake_connection, database_name: str, 
...
def get_table_metadata_with_connection(snowflake_connection, database_name: str, 
                                     schema_name: str, table_name: str) -> Dict[str, Any]:
    """
    Get additional table metadata beyond columns using pre-established connection
    Enhanced metadata collection
    """
    try:
        cursor = snowflake_connection.cursor()

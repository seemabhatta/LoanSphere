            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="label-text text-neutral-500">Boarding Completion Rate</p>
                      <p className={`metric-large mt-2 ${getMetricColor(performanceSummary?.summary?.boarding_completion_rate || 0)}`} data-testid="kpi-boarding">
                        {performanceSummary?.summary?.boarding_completion_rate || 0}%
                      </p>
                      <div className="flex items-center mt-2 body-text">
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="label-text text-neutral-500">Exception Resolution Rate</p>
                      <p className={`metric-large mt-2 ${getMetricColor(performanceSummary?.summary?.exception_resolution_rate || 0, 85)}`} data-testid="kpi-exceptions">
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="label-text text-neutral-500">Compliance Rate</p>
                      <p className={`metric-large mt-2 ${getMetricColor(performanceSummary?.summary?.compliance_completion_rate || 0, 95)}`} data-testid="kpi-compliance">
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="detail-text text-neutral-500 mt-1">Target: 2.0h</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="detail-text text-neutral-500 mt-1">Target: 90%</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="detail-text text-neutral-500 mt-1">Target: 75%</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="detail-text text-neutral-500 mt-1">Target: &lt;10</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                  <div>
                    <h3 className="section-header text-neutral-800 mb-2">Total Loans</h3>
                    <p className="metric-large text-neutral-800" data-testid="volume-total-loans">
                      {performanceSummary?.summary?.total_loans || 0}
                    </p>
                  </div>
                  <div>
                    <h3 className="section-header text-neutral-800 mb-2">Total Exceptions</h3>
                    <p className="metric-large text-neutral-800" data-testid="volume-total-exceptions">
                      {performanceSummary?.summary?.total_exceptions || 0}
                    </p>
                  </div>
                  <div>
                    <h3 className="section-header text-neutral-800 mb-2">Compliance Events</h3>
                    <p className="metric-large text-neutral-800" data-testid="volume-compliance-events">
